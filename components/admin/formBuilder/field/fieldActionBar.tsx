  ...
  return (
    <>
      <div className="w-full pt-4 mt-8 border-t border-blue-200 flex justify-end items-center">
        ...
        <span className="inline-block border-r-2 border-blue-200 w-2">
          &nbsp;
        </span>
        ...
        >
          <input
            ...
            id="scan-toggle"
            className="sr-only peer"
            checked={field.isScan}
            onChange={() => field.toggleScan()}
          />
          <div
            className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 
            peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full 
            ...
            "
          ></div>
          <span className="ml-2 text-sm font-medium text-gray-900">Scan</span>
        </label>
        {/* More advance menu */}
        <button
          type="button"
