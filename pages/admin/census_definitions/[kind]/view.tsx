import CensusDefinitionDetail from "components/admin/censusDefinition/detail";
...
const AdminCensusDefinitionViewPage: NextPage = () => {
  ...
  return (
    <Protect guard={(store: Store) => store.isSuperUser}>
      <Layout>
        ...
        />
        <CensusDefinitionDetail kind={kind} />
      </Layout>
    </Protect>
  );
};

export default AdminCensusDefinitionViewPage;
